...
export const toolDefinitions = [
  ...
  define('run_command', 'Run a command with a literal argument array, subject to session approval settings. No shell pipelines or redirection. Inspect ok, exit_code, stdout and stderr; nonzero exits and timeouts are failures.', {
    executable: { type: 'string', enum: ALLOWED_EXECUTABLES },
    args: { type: 'array', items: { type: 'string' }, maxItems: 40, description: 'Separate array entries for each argument. Defaults to [].' },
    cwd: directoryPath,
